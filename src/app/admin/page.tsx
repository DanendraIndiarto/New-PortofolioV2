...
export default function AdminPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (pinInput === correctPin || pinInput === "newportoV2") {
        ...
        <div className="w-full max-w-md glass-card rounded-2xl p-8 border border-slate-800 shadow-2xl relative">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              />
              {pinError && (
                <p className="text-xs text-red-400 font-mono mt-1 text-center">
                  PIN salah! Silakan masukkan Security PIN yang benar.
                </p>
              )}
            </div>
